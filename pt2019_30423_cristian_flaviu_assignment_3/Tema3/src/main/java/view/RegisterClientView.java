...
public class RegisterClientView extends JFrame {
	...
	public void updateNameTextField(String message)
	{
	textFieldClientName.setText(message);
	}
	public void updateAgeTextField(String message)
	{
		textFieldAge.setText(message);
	}
	public void setAdressTextField(String message)
	{
		textFieldAdress.setText(message);
	}
	public void  setEmailTextField(String message)
	{
		textFieldEmail.setText(message);
	}
}
